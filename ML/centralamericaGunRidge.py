...
file = open("camericagun1990bigtest.csv", "r")
...
file2 = open("camericagun1990smalltrain.csv", "r")
...
colors2 = ['teal', 'yellowgreen', 'gold', "navy"] # left for self reference
lw = 2 # linewidth

plt.scatter(ysubset, ksubset, color='navy', s=20, marker='o', label="training points")
...
plt.plot(ylist, y_plot, color="red", linewidth=lw, label="Ridge")
